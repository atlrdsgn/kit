/*! 
     ...
     */
import v, { createContext as Ia, useContext as Da, useState as po, useEffect as jo, forwardRef as fi, createElement as yo, Children as Ma, useRef as Fa, useMemo as Va } from "react";
import f from "clsx";
...
function Wa() {
  if (lo)
    return di;
  lo = 1;
  var i = v, a = Symbol.for("react.element"), e = Symbol.for("react.fragment"), r = Object.prototype.hasOwnProperty, s = i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, n = { key: !0, ref: !0, __self: !0, __source: !0 };
  function d(u, c, y) {
...
function Xa() {
  return to || (to = 1, process.env.NODE_ENV !== "production" && function() {
    var i = v, a = Symbol.for("react.element"), e = Symbol.for("react.portal"), r = Symbol.for("react.fragment"), s = Symbol.for("react.strict_mode"), n = Symbol.for("react.profiler"), d = Symbol.for("react.provider"), u = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), y = Symbol.for("react.suspense"), k = Symbol.for("react.suspense_list"), _ = Symbol.for("react.memo"), P = Symbol.for("react.lazy"), B = Symbol.for("react.offscreen"), U = Symbol.iterator, li = "@@iterator";
    function X(o) {
    ...
    function T(o, l, g) {
      {
        ...
        j !== "" && (l += "%s", g = g.concat([j]));
        var C = g.map(function(p) {
          return String(p);
        });
        C.unshift("Warning: " + l), Function.prototype.apply.call(console[o], console, C);
      }
    }
    var Si = !1, Xi = !1, b = !1, x = !1, Z = !1, J;
    J = Symbol.for("react.module.reference");
    function pi(o) {
      return !!(typeof o == "string" || typeof o == "function" || o === r || o === n || Z || o === s || o === y || o === k || x || o === B || Si || Xi || b || typeof o == "object" && o !== null && (o.$$typeof === P || o.$$typeof === _ || o.$$typeof === d || o.$$typeof === u || o.$$typeof === c || // This needs to include all possible module reference object
    ...
    function S(o) {
      ...
      if (typeof o == "object")
        switch (o.$$typeof) {
          ...
          case c:
            return ti(o, o.render, "ForwardRef");
          case _:
            var m = o.displayName || null;
            return m !== null ? m : S(o.type) || "Memo";
          case P: {
            var j = o, C = j._payload, p = j._init;
            try {
              return S(p(C));
            } catch {
              return null;
...
` + h[w].replace(" at new ", " at ");
      ...
      var ei = o ? o.displayName || o.name : "", so = ei ? Ci(ei) : "";
    ...
    var bi = Object.prototype.hasOwnProperty, Gi = {}, Ui = L.ReactDebugCurrentFrame;
    function _i(o) {
      if (o) {
        var l = o._owner, g = xi(o.type, o._source, l ? l.type : null);
        Ui.setExtraStackFrame(g);
      } else
        Ui.setExtraStackFrame(null);
    }
    function pa(o, l, g, m, j) {
      {
          ...
          if (C(o, p)) {
            ...
            try {
              if (typeof o[p] != "function") {
                var z = Error((m || "React class") + ": " + g + " type `" + p + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof o[p] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw z.name = "Invariant Violation", z;
              }
              h = o[p](l, p, m, g, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (w) {
              h = w;
            }
            h && !(h instanceof Error) && (_i(j), q("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", m || "React class", g, p, typeof h), _i(null)), h instanceof Error && !(h.message in Gi) && (Gi[h.message] = !0, _i(j), q("Failed %s type: %s", g, h.message), _i(null));
          }
      }
    }
    ...
    function Ki(o) {
      if (Ca(o))
        return q("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", ya(o)), Yi(o);
    }
    ...
    function _a(o, l) {
      if (typeof o.ref == "string" && gi.current && l && gi.current.stateNode !== l) {
    ...
    function wa(o, l) {
      {
        var g = function() {
          Zi || (Zi = !0, q("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", l));
        };
    ...
    function Na(o, l) {
      {
        var g = function() {
          Ji || (Ji = !0, q("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", l));
        };
    ...
    function Ra(o, l, g, m, j) {
      {
        var C, p = {}, h = null, z = null;
        g !== void 0 && (Ki(g), h = "" + g), ba(l) && (Ki(l.key), h = "" + l.key), xa(l) && (z = l.ref, _a(l, j));
        for (C in l)
          bi.call(l, C) && !ka.hasOwnProperty(C) && (p[C] = l[C]);
        if (o && o.defaultProps) {
        ...
        return qa(o, h, z, j, m, gi.current, p);
      }
    }
    var Oi = L.ReactCurrentOwner, Qi = L.ReactDebugCurrentFrame;
    function ai(o) {
      if (o) {
        var l = o._owner, g = xi(o.type, o._source, l ? l.type : null);
        Qi.setExtraStackFrame(g);
      } else
    ...
    function eo(o, l) {
      {
        ...
        if (Ti(o))
          ...
          if (typeof j == "function" && j !== o.entries)
            for (var C = j.call(o), p; !(p = C.next()).done; )
              Ii(p.value) && ao(p.value, l);
        }
      }
    }
    function Aa(o) {
      {
        ...
        if (g) {
          var m = S(l);
          pa(g, o.props, "prop", m, o);
        } else if (l.PropTypes !== void 0 && !Li) {
          Li = !0;
          var j = S(l);
...
process.env.NODE_ENV === "production" ? Mi.exports = Wa() : Mi.exports = Xa();
var t = Mi.exports;
const ko = Ia({
  theme: "light",
  toggleTheme: () => {
  ...
  const [a, e] = po("light"), r = () => {
    e((n) => n === "light" ? "dark" : "light");
  }, s = a === "light" ? ui.dark : ui.light;
  return /* @__PURE__ */ t.jsx(ko.Provider, { value: { theme: a, toggleTheme: r }, children: /* @__PURE__ */ t.jsx("div", { className: `${ui.base} ${s}`, children: i }) });
};
...
function Di(i) {
  for (var a = 1; a < arguments.length; a++) {
    ...
    a % 2 ? no(Object(e), !0).forEach(function(r) {
      Ja(i, r, e[r]);
      ...
      try {
        ...
        if (typeof b == "string" || typeof b == "number") {
          ...
          for (var Z = 0; Z < b.length; Z++) {
            var J = b[Z];
            if (J != null) {
              var pi = x.responsiveArray[Z];
              if (process.env.NODE_ENV !== "production" && !x.values[J].conditions[pi])
                throw new Error();
              y.push(x.values[J].conditions[pi]);
            }
          }
        else
          for (var ti in b) {
            var Q = b[ti];
            if (Q != null) {
              if (process.env.NODE_ENV !== "production" && !x.values[Q].conditions[ti])
                throw new Error();
              y.push(x.values[Q].conditions[ti]);
            }
          }
      } catch (ji) {
...
}, I7 = bo({ conditions: { defaultCondition: "light", conditionNames: ["light", "dark"], responsiveArray: void 0 } }), _o = bo({ conditions: { defaultCondition: "small", conditionNames: ["small", "medium", "large", "xlarge"], responsiveArray: ["small", "medium", "large", "xlarge"] } }), Fi = oe(function() {
...
const wo = ({ reset: i, ...a }) => {
  ...
  dark: `html${ui.dark} &`
}, go = (i, a) => !a || Object.keys(a).length === 0 ? {} : {
  [ae[i]]: a
}, F7 = ({
  lightMode: i,
  darkMode: a
...
function se(i, a, e) {
  return a = re(a), a in i ? Object.defineProperty(i, a, {
    value: e,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
function uo(i) {
  for (var a = 1; a < arguments.length; a++) {
    var e = arguments[a] != null ? arguments[a] : {};
    a % 2 ? co(Object(e), !0).forEach(function(r) {
      se(i, r, e[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(i, Object.getOwnPropertyDescriptors(e)) : co(Object(e)).forEach(function(r) {
      Object.defineProperty(i, r, Object.getOwnPropertyDescriptor(e, r));
    });
  }
  return i;
...
var le = (i, a, e) => {
  ...
  var a = (e) => {
    var r = i.defaultClassName, s = uo(uo({}, i.defaultVariants), e);
    for (var n in s) {
  ...
  return a.variants = () => Object.keys(i.variantClassNames), a.classNames = {
    ...
    get variants() {
      return fo(i.variantClassNames, (e) => fo(e, (r) => r.split(" ")[0]));
    }
  }, a;
}, te = R({ defaultClassName: "qoireta qoiret9", variantClassNames: { size: { xs: "qoiret0", sm: "qoiret1", md: "qoiret2" }, shape: { rounded: "qoiret3", pill: "qoiret4" }, variant: { carbon: "qoiret6", slate: "qoiret7", jade: "qoiret8" }, removeShadow: { true: "qoiret5" } }, defaultVariants: { size: "sm", shape: "pill", variant: "carbon", removeShadow: !1 }, compoundVariants: [] });
const No = ({
  children: i,
  className: a,
  size: e = "sm",
  ...
  {
    ...d,
    className: f(a, te({ size: e, shape: r, variant: s, removeShadow: n })),
    children: i
  }
);
No.displayName = "Chip";
var ne = R({ defaultClassName: "vmm9ef6 vmm9ef4", variantClassNames: { size: { small: "vmm9ef0", medium: "vmm9ef1" }, variant: { primary: "vmm9ef2" } }, defaultVariants: { size: "small", variant: "primary" }, compoundVariants: [] }), ge = "vmm9ef5", qi = "vmm9ef3";
const Vi = v.forwardRef(
  ({ svg: i, className: a, ...e }, r) => i ? i === "Arrow.Down.Icon" ? /* @__PURE__ */ t.jsx(
    "svg",
    {
      ref: r,
      className: f(qi, a),
  ...
  ) : i === "Small.Arrow.Up.Icon" ? /* @__PURE__ */ t.jsx(
    "svg",
    {
      width: "24",
      height: "7",
  ...
  ) : i === "Small.Arrow.Right.Icon" ? /* @__PURE__ */ t.jsx(
    "svg",
    {
      ref: r,
      className: f(qi, a),
...
const qo = (i) => /* @__PURE__ */ t.jsx(
...
), Ro = v.forwardRef(({ content: i, className: a, ...e }, r) => /* @__PURE__ */ t.jsx(
  "p",
  {
    ref: r,
    className: f(ge, a),
  ...
  ({ variant: i = "primary", size: a = "small", className: e, ...r }, s) => /* @__PURE__ */ t.jsx(
    "div",
    {
      ...r,
      ref: s,
      className: f(ne({ size: a, variant: i }), e)
    }
  )
), Y = (i) => /* @__PURE__ */ t.jsx(So, { ...i });
Y.displayName = "Badge";
Y.Label = qo;
Y.Content = Ro;
Y.Icon = Vi;
...
const fe = ({
  ...
  return /* @__PURE__ */ t.jsx(
    "button",
    {
      ...y,
      type: a,
      className: ue({ size: d, variant: u, font: c }),
      onClick: k,
      children: i
    }
  );
...
var me = R({ defaultClassName: "_1cc3smn7 _1cc3smn5", variantClassNames: { z: { default: "_1cc3smn0", blur: "_1cc3smn1", normal: "_1cc3smn2", top: "_1cc3smn3", max: "_1cc3smn4" } }, defaultVariants: { z: "default" }, compoundVariants: [] }), he = "_1cc3smn6";
const ve = v.forwardRef(
  ({ children: i, className: a, z: e = "default", ...r }, s) => /* @__PURE__ */ t.jsx(
    "div",
    {
      ref: s,
      className: f(a, me({ z: e })),
      ...r,
      children: i
    }
  )
), pe = v.forwardRef(
  ({ children: i, className: a, ...e }, r) => /* @__PURE__ */ t.jsx(
    "div",
    {
      ref: r,
      className: f(a, he),
...
pe.displayName = "CanvasBlur";
var je = "_108km3d0", ye = "_108km3d1", Ce = R({ defaultClassName: "_108km3d9", variantClassNames: { level: { H1: "_108km3d3", H2: "_108km3d4", H3: "_108km3d5", H4: "_108km3d6", H5: "_108km3d7", H6: "_108km3d8" } }, defaultVariants: { level: "H2" }, compoundVariants: [] });
const zo = v.forwardRef(
...
const hi = (i) => /* @__PURE__ */ t.jsx(zo, { ...i });
hi.Content = Ao;
hi.Header = Eo;
hi.displayName = "Card";
...
const xe = ({
  ...
  {
    ...d,
    className: f(a, ke({ width: e, align: r, border: s, flush: n })),
    children: i
  }
);
xe.displayName = "Container";
var be = "_1g4daxf1", _e = "_1g4daxf2", we = "_1g4daxf6", Ne = "_1g4daxf0";
const qe = D.Root, To = D.Group, Po = D.Label, Oo = D.ItemIndicator, Lo = D.Sub, Io = D.SubTrigger, Do = D.SubContent, Mo = v.forwardRef(({ className: i, asChild: a, ...e }, r) => /* @__PURE__ */ t.jsx(
  D.Trigger,
  {
    ...e,
    ref: r,
  ...
  ({ className: i, onSelect: a, textValue: e, asChild: r, disabled: s, ...n }, d) => /* @__PURE__ */ t.jsx(
    D.Item,
    {
      ...n,
      ref: d,
...
), Bo = v.forwardRef((i, a) => /* @__PURE__ */ t.jsx(
  D.Separator,
  {
    ...i,
    ref: a,
    className: f(we, i.className)
  }
)), M = (i) => /* @__PURE__ */ t.jsx(qe, { ...i });
...
M.SubContent = Do;
M.SubTrigger = Io;
Fo.displayName = "DropdownContent";
Mo.displayName = "DropdownTrigger";
...
const Se = v.forwardRef(
  ({
    ...
    "div",
    {
      ...n,
      ref: d,
      className: Re({ direction: a, align: e, justify: r, gap: s }),
      children: i
    }
  )
);
Se.displayName = "Flex";
var ze = "t7bfpz2", Ae = "var(--t7bfpz0)", Ee = "var(--t7bfpz1)";
function mo(i) {
  var a = i.match(/^var\((.*)\)$/);
  return a ? a[1] : i;
}
...
const Bi = fi(
  ({ as: i = "div", className: a, ...e }, r) => {
    const s = {}, n = {};
    for (const u in e)
      Fi.properties.has(u) ? s[u] = e[u] : n[u] = e[u];
    const d = wo({
...
Bi.displayName = "RectBox";
Oe.displayName = "Box";
const Le = v.forwardRef(function({
  children: a,
  ...
  return /* @__PURE__ */ t.jsx(
    Bi,
    {
      ...
      style: {
        ...
        ...Pe({
          [Ae]: e,
          [Ee]: r && String(r) || String(Ma.count(a))
        })
      },
      flexDirection: "row",
      children: a
...
const De = v.forwardRef(
  ({
    ...
    "h1",
    {
      ...n,
      ref: d,
      className: f(i, Ie({ font: a, size: e, weight: r, align: s }))
    }
  )
);
De.displayName = "Heading";
var Me = R({ defaultClassName: "_1au2jjeb _1au2jjea", variantClassNames: { inputSize: { xs: "_1au2jje3", sm: "_1au2jje4", md: "_1au2jje5" }, variant: { carbon: "_1au2jje6", jade: "_1au2jje7", orange: "_1au2jje8", sapphire: "_1au2jje9" } }, defaultVariants: { inputSize: "sm", variant: "carbon" }, compoundVariants: [] }), Fe = "_1au2jje0", Ve = "_1au2jje1", Be = "_1au2jje2";
const He = ({
  className: i,
  autoFocus: a = !1,
  autoComplete: e = "off",
...
}, We = ({ className: i, ...a }) => /* @__PURE__ */ t.jsx(
  "input",
  {
    ...a,
    className: f(Be, i),
...
), Wo = v.forwardRef(({ className: i, htmlFor: a, ...e }, r) => /* @__PURE__ */ t.jsx(
  Ba.Root,
  {
    ...e,
    ref: r,
...
), vi = ({ type: i, ...a }) => i === "number" ? /* @__PURE__ */ t.jsx(We, { ...a }) : /* @__PURE__ */ t.jsx(He, { ...a });
vi.Wrapper = Xo;
vi.Label = Wo;
vi.displayName = "Input";
vi.Wrapper.displayName = "Input.Wrapper";
Xo.displayName = "Input.Wrapper";
vi.Label.displayName = "Input.Label";
Wo.displayName = "InputLabel";
var Xe = "_1u7l9ej3", $e = "_1u7l9ej7", Ge = "_1u7l9ej0", Ue = "_1u7l9ej1";
const $o = ri.Menu, Go = ri.Separator, Uo = v.forwardRef(({ className: i, ...a }, e) => /* @__PURE__ */ t.jsx(
  ri.Root,
  {
    ...a,
    ref: e,
...
)), Yo = v.forwardRef(({ className: i, asChild: a = !1, ...e }, r) => /* @__PURE__ */ t.jsx(
  ri.Trigger,
  {
    ...e,
    ref: r,
...
), Zo = v.forwardRef(({ className: i, ...a }, e) => /* @__PURE__ */ t.jsx(
  ri.Item,
  {
    ...a,
    ref: e,
...
)), F = (i) => /* @__PURE__ */ t.jsx(Uo, { ...i });
F.Collection = $o;
F.Trigger = Yo;
F.Content = Ko;
F.Item = Zo;
F.Separator = Go;
F.displayName = "Menubar";
...
const Ke = fi(
  ({
    ...
    "a",
    {
      ...
      href: e,
      target: s,
      className: f(a, Ye({ size: n, variant: r, font: d, weight: u })),
      ...c,
      children: i
    }
  )
);
Ke.displayName = "PassLink";
var Ze = "cubg342", Je = "cubg341", Qe = "cubg340";
const i7 = mi.Root, Jo = v.forwardRef(({ children: i, className: a, asChild: e, ...r }, s) => /* @__PURE__ */ t.jsx(
  mi.Trigger,
  {
    ...r,
    ref: s,
...
), ia = v.forwardRef(({ children: i, className: a, asChild: e, ...r }, s) => /* @__PURE__ */ t.jsx(
  mi.Close,
  {
    ...r,
    ref: s,
...
var o7 = R({ defaultClassName: "_15gsuyj5 _15gsuyj4", variantClassNames: { size: { sm: "_15gsuyj0", md: "_15gsuyj1", lg: "_15gsuyj2", vw: "_15gsuyj3" } }, defaultVariants: { size: "vw" }, compoundVariants: [] });
const a7 = ({
  children: i,
  className: a,
  size: e = "vw",
  ...
  {
    ...r,
    className: f(a, o7({ size: e })),
    children: i
  }
);
a7.displayName = "Section";
var e7 = "_1oghhg39", r7 = "_1oghhg38", s7 = "_1oghhg31", l7 = "_1oghhg35", t7 = "_1oghhg34", n7 = "_1oghhg33", g7 = "_1oghhg32", d7 = "_1oghhg30";
const c7 = ({
...
), oa = E.Group, h7 = E.Value, aa = E.Separator, ea = E.Label, Hi = v.forwardRef(({ className: i, asChild: a, ...e }, r) => /* @__PURE__ */ t.jsx(
  E.Icon,
  {
    ...e,
    ref: r,
    asChild: a,
    className: f(l7, i),
    children: /* @__PURE__ */ t.jsx(c7, {})
  }
)), ra = v.forwardRef(({ className: i, placeholder: a, ...e }, r) => /* @__PURE__ */ t.jsxs(
  E.Trigger,
  {
    ...e,
    ref: r,
    className: f(d7, i),
    children: [
      /* @__PURE__ */ t.jsx(h7, { placeholder: a }),
      /* @__PURE__ */ t.jsx(Hi, {})
    ]
  }
)), sa = v.forwardRef(
  ({
    ...
    E.Content,
    {
      ...
      hideWhenDetached: y,
      children: [
        /* @__PURE__ */ t.jsx(E.ScrollUpButton, { className: f(r7, a), children: /* @__PURE__ */ t.jsx(f7, {}) }),
        /* @__PURE__ */ t.jsx(E.Viewport, { children: i }),
        /* @__PURE__ */ t.jsx(E.ScrollDownButton, { className: f(e7, a), children: /* @__PURE__ */ t.jsx(u7, {}) })
      ]
    }
  )
), la = v.forwardRef(({ className: i, children: a, textValue: e, value: r, ...s }, n) => /* @__PURE__ */ t.jsxs(
  E.Item,
  {
    ...s,
    ref: n,
    ...
    className: f(n7, i),
    children: [
      /* @__PURE__ */ t.jsx(E.ItemText, { className: f(g7, i), children: a }),
      /* @__PURE__ */ t.jsx(E.ItemIndicator, { className: f(t7, i), children: /* @__PURE__ */ t.jsx(m7, {}) })
    ]
  }
)), A = (i) => /* @__PURE__ */ t.jsx(E.Root, { ...i });
A.Trigger = ra;
A.Content = sa;
A.Item = la;
A.Icon = Hi;
...
la.displayName = "SelectItem";
A.Icon.displayName = "Select.Icon";
Hi.displayName = "SelectIcon";
...
const ho = {
  ...
  i,
  (a) => j7[a]
) : void 0, C7 = (i) => i ? typeof i == "boolean" ? ho[1] : _o(
...
var k7 = R({ defaultClassName: "_1sci2lp6 _1sci2lp0", variantClassNames: { size: { small: "_1sci2lp2", medium: "_1sci2lp3" } }, defaultVariants: { size: "small" }, compoundVariants: [] }), x7 = R({ defaultClassName: "_1sci2lp9 _1sci2lp1", variantClassNames: { size: { small: "_1sci2lp4", medium: "_1sci2lp5" } }, defaultVariants: { size: "small" }, compoundVariants: [] });
const b7 = ({
  className: i,
  asChild: a,
  defaultChecked: e,
  ...
  return /* @__PURE__ */ t.jsx(
    Co.Thumb,
    {
      ...
      ref: a,
      asChild: s,
      className: f(e, x7({ size: r }))
    }
  );
}), Wi = (i) => /* @__PURE__ */ t.jsx(b7, { ...i });
Wi.Toggle = ta;
Wi.displayName = "Switch";
Wi.Toggle.displayName = "Switch.Toggle";
ta.displayName = "Switch.Toggle";
var _7 = "wzz0re3", w7 = "wzz0re2", N7 = "wzz0re1";
const na = v.forwardRef(({ children: i, className: a, asChild: e, loop: r = !0, ...s }, n) => /* @__PURE__ */ t.jsx(
  Ri.List,
  {
    ...s,
    ref: n,
...
)), ga = v.forwardRef(({ children: i, className: a, asChild: e, value: r, disabled: s, ...n }, d) => /* @__PURE__ */ t.jsx(
  Ri.Trigger,
  {
    ...n,
    ref: d,
...
)), da = v.forwardRef(({ children: i, className: a, asChild: e, value: r, ...s }, n) => /* @__PURE__ */ t.jsx(
  Ri.Content,
  {
    ...s,
    ref: n,
...
const R7 = v.forwardRef(
  ({
    ...
    "p",
    {
      ...
      className: f(
        a,
        q7({ font: e, size: r, align: s, weight: n, color: d, casing: u })
      ),
      ...c,
      children: i
    }
...
R7.displayName = "Text";
const S7 = v.forwardRef(({ children: i, asChild: a, ...e }, r) => /* @__PURE__ */ t.jsx(t.Fragment, { children: /* @__PURE__ */ t.jsx(
  Ha.Root,
  {
    ...e,
    ref: r,
...
}, z7 = "140, 145, 158", A7 = "102, 102, 102", vo = "43, 43, 43", W7 = {
  primary: {
    initial: `0px 1px 2px rgba(${vo}, 0.3)`,
    // 0px 1px 2px
    hover: `0px 2px 3px rgba(${A7}, 0.3)`,
    // 0px 2px 3px
    focus: `0px 1px 2px rgba(${vo}, 0.3), 0px 0px 1px 3px rgba(${z7}, 0.4)`
