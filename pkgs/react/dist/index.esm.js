...
const __ = k_({
  ...
  const [r, l] = u_("light"), o = () => {
    l((e) => e === "light" ? "dark" : "light");
  }, i = r === "light" ? z.dark : z.light;
  return /* @__PURE__ */ d(__.Provider, { value: { theme: r, toggleTheme: o }, children: /* @__PURE__ */ d("div", { className: `${z.base} ${i}`, children: _ }) });
};
function r_(_) {
  var r, l, o = "";
...
function z_(_, r, l) {
  return r = y_(r), r in _ ? Object.defineProperty(_, r, {
    value: l,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
function O(_) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    r % 2 ? G(Object(l), !0).forEach(function(o) {
      z_(_, o, l[o]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(_, Object.getOwnPropertyDescriptors(l)) : G(Object(l)).forEach(function(o) {
...
var w_ = (_) => function() {
  ...
  var i = Object.assign({}, ...l.map((n) => n.styles)), e = Object.keys(i), s = e.filter((n) => "mappings" in i[n]), a = (n) => {
    ...
    for (var I of s) {
      ...
      if (W != null) {
        var n_ = i[I];
        B = !0;
        for (var q of n_.mappings)
          f[q] = W, m[q] == null && delete m[q];
      }
    }
    var R = B ? O(O({}, f), m) : n, t_ = function() {
      var g = R[h], t = i[h];
      try {
        if (t.mappings)
          return "continue";
        if (typeof g == "string" || typeof g == "number") {
          ...
          for (var w = 0; w < g.length; w++) {
            ...
            if (P != null) {
              ...
              if (process.env.NODE_ENV !== "production" && !t.values[P].conditions[H])
                throw new Error();
              c.push(t.values[P].conditions[H]);
            }
          }
        else
          for (var X in g) {
            var N = g[X];
            if (N != null) {
              if (process.env.NODE_ENV !== "production" && !t.values[N].conditions[X])
                throw new Error();
              c.push(t.values[N].conditions[X]);
            }
          }
      } catch (d_) {
        if (process.env.NODE_ENV !== "production") {
          ...
          if ((typeof g == "string" || typeof g == "number") && (g in t.values || S(h, g, t.values), !t.values[g].defaultClass))
          ...
          if (typeof g == "object") {
            ...
            if (Array.isArray(g)) {
              ...
              var F = t.responsiveArray.length;
              if (F < g.length)
                throw new b('"'.concat(h, '" only supports up to ').concat(F, " breakpoints. You passed ").concat(g.length));
              for (var V of g)
                t.values[V] || S(h, V, t.values);
            } else
              for (var T in g) {
                var y = g[T];
                if (y != null && (t.values[y] || S(h, y, t.values), !t.values[y].conditions[T]))
                  throw new b('"'.concat(h, '" has no condition named ').concat(j(T), ". Possible values are ").concat(Object.keys(t.values[y].conditions).map(j).join(", ")));
              }
          }
        }
        throw d_;
  ...
  return w_(A_)(...arguments);
}, Pr = l_({ conditions: { defaultCondition: "light", conditionNames: ["light", "dark"], responsiveArray: void 0 } }), i_ = l_({ conditions: { defaultCondition: "small", conditionNames: ["small", "medium", "large", "xlarge"], responsiveArray: ["small", "medium", "large", "xlarge"] } }), L = q_(function() {
...
const e_ = ({ reset: _, ...r }) => {
  ...
  dark: `html${z.dark} &`
}, K = (_, r) => !r || Object.keys(r).length === 0 ? {} : {
  [P_[_]]: r
}, Nr = ({
  lightMode: _,
  darkMode: r
...
function S_(_, r, l) {
  return r = N_(r), r in _ ? Object.defineProperty(_, r, {
    value: l,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
function $(_) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    r % 2 ? U(Object(l), !0).forEach(function(o) {
      S_(_, o, l[o]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(_, Object.getOwnPropertyDescriptors(l)) : U(Object(l)).forEach(function(o) {
      Object.defineProperty(_, o, Object.getOwnPropertyDescriptor(l, o));
    });
  }
  return _;
...
var T_ = (_, r, l) => {
  ...
  var r = (l) => {
    var o = _.defaultClassName, i = $($({}, _.defaultVariants), l);
    for (var e in i) {
    ...
    for (var [f, m] of _.compoundVariants)
      T_(f, i, _.defaultVariants) && (o += " " + m);
    return o;
  };
  return r.variants = () => Object.keys(_.variantClassNames), r;
}, D_ = u({ defaultClassName: "banner_BASE_BANNER__11mnmjt9", variantClassNames: { size: { small: "banner_size_small__11mnmjt0", medium: "banner_size_medium__11mnmjt1", large: "banner_size_large__11mnmjt2" }, border: { true: "b a n e r _ o d t u 1 m j 8" }, variant: { one: "banner_variant_one__11mnmjt3", two: "banner_variant_two__11mnmjt4" } }, defaultVariants: { size: "medium", border: !1, variant: "one" }, compoundVariants: [] });
const O_ = ({
  children: _,
  className: r,
  size: l,
...
const M_ = ({
  ...
  const f = (m) => {
    i ? (m.preventDefault(), window.open(i, e, s)) : m.preventDefault(), o(m);
  };
  return /* @__PURE__ */ d(
    "button",
    {
...
var E_ = "canvas_canvas__1cc3smn0";
const B_ = C.forwardRef(
...
B_.displayName = "Canvas";
var I_ = u({ defaultClassName: "chip_CHIP_ROOT__qoiret7", variantClassNames: { size: { xs: "chip_size_xs__qoiret0", sm: "chip_size_sm__qoiret1", md: "chip_size_md__qoiret2" }, shape: { rounded: "chip_shape_rounded__qoiret3", pill: "chip_shape_pill__qoiret4" }, variant: { slate: "chip_variant_slate__qoiret5", jade: "chip_variant_jade__qoiret6" } }, defaultVariants: { size: "sm", shape: "pill", variant: "slate" }, compoundVariants: [] });
const W_ = ({
  children: _,
  className: r,
  size: l = "sm",
...
const V_ = C.forwardRef(
  ({
    ...
    "div",
    {
      ...e,
      ref: s,
      className: F_({ direction: r, align: l, justify: o, gap: i }),
      children: _
    }
  )
);
V_.displayName = "Flex";
var G_ = "grid_grid__t7bfpz2", K_ = "var(--gridItemMinWidth__t7bfpz0)", U_ = "var(--gridMaxRowItems__t7bfpz1)";
function Z(_) {
  var r = _.match(/^var\((.*)\)$/);
  return r ? r[1] : _;
}
...
function s_(_, r) {
  ...
  for (var i in _) {
    var e = _[i], s = [...l, i];
    typeof e == "string" || typeof e == "number" || e == null ? o[i] = r(e, s) : typeof e == "object" && !Array.isArray(e) ? o[i] = s_(e, r, s) : console.warn('Skipping invalid key "'.concat(s.join("."), '". Should be a string, number, null or object. Received: "').concat(Array.isArray(e) ? "Array" : typeof e, '"'));
  }
  return o;
}
function Z_(_, r) {
...
Y_.displayName = "Box";
const J_ = C.forwardRef(function({
  children: r,
  ...
  return /* @__PURE__ */ d(
    M,
    {
      ...e,
      ref: s,
      className: `${G_} ${e.className ?? ""}`,
      style: {
        ...i,
        ...Z_({
          [K_]: l,
          [U_]: o && String(o) || String(m_.count(r))
        })
      },
      flexDirection: "row",
      children: r
...
const _r = C.forwardRef(
  ({
    ...
    "h1",
    {
      ...e,
      ref: s,
      className: p(_, Q_({ font: r, size: l, weight: o, align: i }))
    }
  )
);
_r.displayName = "Heading";
var rr = "popover_popoverClose__cubg343", or = "popover_popoverContent__cubg341", lr = "popover_popoverTrigger__cubg340";
const ir = v.Root, er = v.Arrow, sr = v.Anchor, ar = v.Portal, nr = C.forwardRef(({ children: _, className: r, asChild: l = !1, ...o }, i) => /* @__PURE__ */ d(
  v.Trigger,
  {
    ...o,
    ref: i,
...
), gr = C.forwardRef(({ children: _, className: r, asChild: l, ...o }, i) => /* @__PURE__ */ d(
  v.Close,
  {
    ...o,
    ref: i,
...
var dr = u({ defaultClassName: "section_SEC_ROOT__15gsuyj4", variantClassNames: { size: { sm: "section_size_sm__15gsuyj0", md: "section_size_md__15gsuyj1", lg: "section_size_lg__15gsuyj2", vw: "section_size_vw__15gsuyj3" } }, defaultVariants: { size: "vw" }, compoundVariants: [] });
const cr = ({
  children: _,
  className: r,
  size: l = "vw",
...
const Y = {
  ...
  _,
  (r) => hr[r]
) : void 0, mr = (_) => _ ? typeof _ == "boolean" ? Y[1] : i_(
  _,
...
var fr = u({ defaultClassName: "switch_BASE_ROOT__1sci2lp0", variantClassNames: { size: { small: "switch_rootSize_small__1sci2lp2", medium: "switch_rootSize_medium__1sci2lp3" } }, defaultVariants: { size: "small" }, compoundVariants: [] }), Cr = u({ defaultClassName: "switch_BASE_TOGGLE__1sci2lp1", variantClassNames: { size: { small: "switch_toggleSize_small__1sci2lp4", medium: "switch_toggleSize_medium__1sci2lp5" } }, defaultVariants: { size: "small" }, compoundVariants: [] });
const br = ({
  className: _,
  asChild: r,
  defaultChecked: l,
  ...
  const { className: l, size: o = "small", asChild: i = !1, ...e } = _;
  return /* @__PURE__ */ d(
    Q.Thumb,
    {
      ...e,
...
const xr = C.forwardRef(
  ({
    ...
    "p",
    {
      ...
      className: p(
        r,
        vr({ font: l, size: o, align: i, weight: e, color: s, casing: a })
      ),
      ...n,
      children: _
    }
...
export {
  ...
  e_ as atoms,
  Xr as breakpoints,
  Nr as colorModeStyle,
  wr as kit,
  Pr as mapColorValue,
  i_ as mapResponsiveValue,
  L as sprinkles,
  Ar as useTheme
};
