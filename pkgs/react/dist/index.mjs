...
const Y = ri({
  ...
  const [o, l] = di("light"), a = () => {
    l((g) => g === "light" ? "dark" : "light");
  }, s = o === "light" ? _.dark : _.light;
  return /* @__PURE__ */ c(Y.Provider, { value: { theme: o, toggleTheme: a }, children: /* @__PURE__ */ c("div", { className: `${_.base} ${s}`, children: i }) });
};
function Z(i) {
  var o, l, a = "";
...
function vi(i) {
  ...
  function l(a) {
    ...
    if (Array.isArray(a)) {
      ...
      var s = {};
      for (var g in o.responsiveArray)
        a[g] != null && (s[o.responsiveArray[g]] = a[g]);
      return s;
    }
    return a;
  }
...
function Q(i) {
  ...
  function a(s, g) {
    if (typeof s == "string" || typeof s == "number" || typeof s == "boolean") {
      if (!o.defaultCondition)
        throw new Error("No default condition");
      return g(s, o.defaultCondition);
    }
    var e = Array.isArray(s) ? l(s) : s, t = {};
    for (var r in e)
      e[r] != null && (t[r] = g(e[r], r));
    return t;
  }
  return J(a, {
    importPath: "@vanilla-extract/sprinkles/createUtils",
...
function ki(i, o, l) {
  return o = ji(o), o in i ? Object.defineProperty(i, o, {
    value: l,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
function X(i) {
  for (var o = 1; o < arguments.length; o++) {
    ...
    o % 2 ? I(Object(l), !0).forEach(function(a) {
      ki(i, a, l[a]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(i, Object.getOwnPropertyDescriptors(l)) : I(Object(l)).forEach(function(a) {
...
var Ci = (i) => function() {
  for (var o = arguments.length, l = new Array(o), a = 0; a < o; a++)
    l[a] = arguments[a];
  var s = Object.assign({}, ...l.map((r) => r.styles)), g = Object.keys(s), e = g.filter((r) => "mappings" in s[r]), t = (r) => {
    var u = [], j = {}, m = X({}, r), D = !1;
    for (var V of e) {
      var R = r[V];
      if (R != null) {
        var li = s[V];
        D = !0;
        for (var w of li.mappings)
          j[w] = R, m[w] == null && delete m[w];
      }
    }
    var T = D ? X(X({}, j), m) : r, si = function() {
      var d = T[f], n = s[f];
      try {
        if (n.mappings)
          return "continue";
        if (typeof d == "string" || typeof d == "number") {
          ...
          for (var b = 0; b < d.length; b++) {
            var q = d[b];
            if (q != null) {
              var H = n.responsiveArray[b];
              if (process.env.NODE_ENV !== "production" && !n.values[q].conditions[H])
                throw new Error();
              u.push(n.values[q].conditions[H]);
            }
          }
        else
          for (var z in d) {
            var A = d[z];
            if (A != null) {
              if (process.env.NODE_ENV !== "production" && !n.values[A].conditions[z])
                throw new Error();
              u.push(n.values[A].conditions[z]);
            }
          }
      } catch (ei) {
        if (process.env.NODE_ENV !== "production") {
          class p extends Error {
            constructor(O) {
              super(O), this.name = "SprinklesError";
            }
          }
          var C = (k) => typeof k == "string" ? '"'.concat(k, '"') : k, P = (k, O, ti) => {
            throw new p('"'.concat(k, '" has no value ').concat(C(O), ". Possible values are ").concat(Object.keys(ti).map(C).join(", ")));
          };
          if (!n)
            throw new p('"'.concat(f, '" is not a valid sprinkle'));
          if ((typeof d == "string" || typeof d == "number") && (d in n.values || P(f, d, n.values), !n.values[d].defaultClass))
            throw new p('"'.concat(f, '" has no default condition. You must specify which conditions to target explicitly. Possible options are ').concat(Object.keys(n.values[d].conditions).map(C).join(", ")));
          if (typeof d == "object") {
            ...
            if (Array.isArray(d)) {
              ...
              var M = n.responsiveArray.length;
              if (M < d.length)
                throw new p('"'.concat(f, '" only supports up to ').concat(M, " breakpoints. You passed ").concat(d.length));
              for (var F of d)
                n.values[F] || P(f, F, n.values);
            } else
              for (var N in d) {
                var y = d[N];
                if (y != null && (n.values[y] || P(f, y, n.values), !n.values[y].conditions[N]))
                  throw new p('"'.concat(f, '" has no condition named ').concat(C(N), ". Possible values are ").concat(Object.keys(n.values[y].conditions).map(C).join(", ")));
              }
          }
        }
        throw ei;
  ...
  return Ci(yi)(...arguments);
}, co = Q({ conditions: { defaultCondition: "light", conditionNames: ["light", "dark"], responsiveArray: void 0 } }), ii = Q({ conditions: { defaultCondition: "small", conditionNames: ["small", "medium", "large", "xlarge"], responsiveArray: ["small", "medium", "large", "xlarge"] } }), E = _i(function() {
...
const oi = ({ reset: i, ...o }) => {
  ...
  light: `html:not(${_.light}) &`,
  dark: `html${_.dark} &`
}, W = (i, o) => !o || Object.keys(o).length === 0 ? {} : {
  [xi[i]]: o
}, fo = ({
  lightMode: i,
  darkMode: o
...
function qi(i, o, l) {
  return o = wi(o), o in i ? Object.defineProperty(i, o, {
    value: l,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
function K(i) {
  for (var o = 1; o < arguments.length; o++) {
    var l = arguments[o] != null ? arguments[o] : {};
    o % 2 ? B(Object(l), !0).forEach(function(a) {
      qi(i, a, l[a]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(i, Object.getOwnPropertyDescriptors(l)) : B(Object(l)).forEach(function(a) {
      Object.defineProperty(i, a, Object.getOwnPropertyDescriptor(l, a));
    });
  }
  return i;
...
var zi = (i, o, l) => {
  ...
  var o = (l) => {
    var a = i.defaultClassName, s = K(K({}, i.defaultVariants), l);
    for (var g in s) {
      var e, t = (e = s[g]) !== null && e !== void 0 ? e : i.defaultVariants[g];
      if (t != null) {
        var r = t;
        typeof r == "boolean" && (r = r === !0 ? "true" : "false");
        var u = (
          // @ts-expect-error
          i.variantClassNames[g][r]
        );
        u && (a += " " + u);
      }
    }
    for (var [j, m] of i.compoundVariants)
      zi(j, s, i.defaultVariants) && (a += " " + m);
    return a;
  };
  return o.variants = () => Object.keys(i.variantClassNames), o;
}, Ai = v({ defaultClassName: "_11mnmjtb", variantClassNames: { size: { small: "_11mnmjt0", medium: "_11mnmjt1", large: "_11mnmjt2" }, border: { true: "_11mnmjt9", false: "_11mnmjta" }, variant: { one: "_11mnmjt3", two: "_11mnmjt4" } }, defaultVariants: { size: "medium", border: !1, variant: "one" }, compoundVariants: [] });
const Pi = ({
  children: i,
  className: o,
  size: l,
  ...
  {
    ...g,
    className: h(o, Ai({ size: l, variant: a, border: s })),
    children: i
  }
);
Pi.displayName = "Banner";
var Ni = v({ defaultClassName: "_1lxtq9d6", variantClassNames: { size: { xs: "_1lxtq9d0", sm: "_1lxtq9d1", md: "_1lxtq9d2", lg: "_1lxtq9d3" }, variant: { slate: "_1lxtq9d4", jade: "_1lxtq9d5" } }, defaultVariants: { size: "sm", variant: "slate" }, compoundVariants: [] });
const Oi = ({
  children: i,
  type: o = "button",
  as: l = "a",
  ...
  const j = (m) => {
    s ? (m.preventDefault(), window.open(s, g, e)) : m.preventDefault(), a(m);
  };
  return /* @__PURE__ */ c(
    "button",
    {
...
Si.displayName = "Canvas";
var Ei = v({ defaultClassName: "qoiret6", variantClassNames: { size: { xs: "qoiret0", sm: "qoiret1", md: "qoiret2" }, shape: { rounded: "qoiret3", pill: "qoiret4" }, variant: { slate: "qoiret5" } }, defaultVariants: { size: "sm", shape: "pill", variant: "slate" }, compoundVariants: [] });
const Li = ({
  children: i,
  className: o,
  size: l = "sm",
  ...
  {
    ...g,
    className: h(o, Ei({ size: l, shape: a, variant: s })),
    children: i
  }
);
Li.displayName = "Chip";
var Di = v({ defaultClassName: "_1lnq7joa", variantClassNames: { align: { start: "_1lnq7jo6", center: "_1lnq7jo7", end: "_1lnq7jo8" }, width: { small: "_1lnq7jo0", medium: "_1lnq7jo1", large: "_1lnq7jo2", xlarge: "_1lnq7jo3", max: "_1lnq7jo4", full: "_1lnq7jo5" }, border: { true: "_1lnq7jo9" } }, defaultVariants: { align: "start", width: "max", border: !1 }, compoundVariants: [] });
const Vi = ({
  children: i,
  className: o,
  width: l = "max",
...
const Ti = x.forwardRef(
  ({
    ...
    "div",
    {
      ...g,
      ref: e,
      className: Ri({ direction: o, align: l, justify: a, gap: s }),
      children: i
    }
  )
);
Ti.displayName = "Flex";
var Hi = "t7bfpz2", Mi = "var(--t7bfpz0)", Fi = "var(--t7bfpz1)";
function G(i) {
  var o = i.match(/^var\((.*)\)$/);
  return o ? o[1] : i;
}
...
function ai(i, o) {
  ...
  for (var s in i) {
    var g = i[s], e = [...l, s];
    typeof g == "string" || typeof g == "number" || g == null ? a[s] = o(g, e) : typeof g == "object" && !Array.isArray(g) ? a[s] = ai(g, o, e) : console.warn('Skipping invalid key "'.concat(e.join("."), '". Should be a string, number, null or object. Received: "').concat(Array.isArray(g) ? "Array" : typeof g, '"'));
  }
  return a;
}
function Wi(i, o) {
...
const L = S(
  ({ as: i = "div", className: o, ...l }, a) => {
    const s = {}, g = {};
    for (const t in l)
      E.properties.has(t) ? s[t] = l[t] : g[t] = l[t];
    const e = oi({
...
L.displayName = "RectBox";
Bi.displayName = "Box";
const Ki = x.forwardRef(function({
  children: o,
  ...
  return /* @__PURE__ */ c(
    L,
    {
      ...g,
      ref: e,
      className: `${Hi} ${g.className ?? ""}`,
      style: {
        ...s,
        ...Wi({
          [Mi]: l,
          [Fi]: a && String(a) || String(ci.count(o))
        })
      },
      flexDirection: "row",
      children: o
...
const $i = x.forwardRef(
  ({
    ...
    "h1",
    {
      ...g,
      ref: e,
      className: h(i, Gi({ font: o, size: l, weight: a, align: s }))
    }
  )
);
$i.displayName = "Heading";
var Ui = v({ defaultClassName: "_15gsuyj4", variantClassNames: { size: { sm: "_15gsuyj0", md: "_15gsuyj1", lg: "_15gsuyj2", vw: "_15gsuyj3" } }, defaultVariants: { size: "vw" }, compoundVariants: [] });
const Yi = ({
  children: i,
  className: o,
  size: l = "vw",
  ...
  {
    ...a,
    className: h(o, Ui({ size: l })),
    children: i
  }
);
Yi.displayName = "Section";
var Zi = v({ defaultClassName: "_19q0mtsb", variantClassNames: { size: { xs: "_19q0mts0", sm: "_19q0mts1", md: "_19q0mts2", lg: "_19q0mts3", xl: "_19q0mts4", xxl: "_19q0mts5", "3xl": "_19q0mts6", "4xl": "_19q0mts7", "5xl": "_19q0mts8", "6xl": "_19q0mts9", "7xl": "_19q0mtsa" } }, defaultVariants: { size: "sm" }, compoundVariants: [] });
const Ji = S(
...
const $ = {
  ...
  i,
  (o) => Qi[o]
) : void 0, oo = (i) => i ? typeof i == "boolean" ? $[1] : ii(
  i,
...
const lo = x.forwardRef(
  ({
    ...
    "p",
    {
      ...
      className: h(
        o,
        ao({ font: l, size: a, align: s, weight: g, color: e, casing: t })
      ),
      ...r,
      children: i
    }
...
export {
  ...
  oi as atoms,
  uo as breakpoints,
  fo as colorModeStyle,
  to as kit,
  co as mapColorValue,
  ii as mapResponsiveValue,
  E as sprinkles,
  ro as useTheme
};
